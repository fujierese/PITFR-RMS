...
@section('content')
<div class="space-y-6">
    <x-page-header eyebrow="Requests" title="Needs Revision" description="Requests that require the requester to update their reservation details." accent="amber">
    ...
    <div class="rounded-3xl bg-white p-6 shadow-sm ring-1 ring-slate-200/50">
        @include('supply-office.partials.request-filters', ['action' => route('supply-office.requests.needs-reschedule')])
                ...
                <tbody class="divide-y divide-slate-100">
                    @forelse($requests as $request)
                        <tr class="transition hover:bg-slate-50 focus-within:bg-slate-50">
                            ...
                            <td class="px-4 py-4"><x-status-badge status="needs_reschedule" label="Needs Revision" /></td>
