...
<div class="space-y-6">
    ...
    <div class="rounded-3xl bg-white p-6 shadow-sm ring-1 ring-slate-200/50">
        <form method="GET" action="{{ route('supply-office.requests.rejected') }}" class="mb-6 grid gap-3 md:grid-cols-4">
            ...
            <a href="{{ route('supply-office.requests.rejected') }}" class="rounded-xl border border-slate-300 px-4 py-2 text-center text-sm font-semibold text-slate-700 hover:bg-slate-100">Clear</a>
        </form>
