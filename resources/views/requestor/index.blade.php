...
<div class="space-y-4 md:space-y-6">
    <section class="rounded-[24px] border border-slate-200 bg-white p-4 shadow-[0_20px_60px_rgba(15,23,42,0.08)] sm:p-6 md:rounded-[32px] lg:p-8">
        <div class="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
            <div class="max-w-2xl">
                <p class="text-sm font-semibold uppercase tracking-[0.3em] text-emerald-600">Requestor workspace</p>
                <h1 class="mt-3 text-2xl font-semibold text-slate-950 sm:text-3xl md:text-4xl">{{ $activeTab === 'requests' ? 'My Requests' : 'Dashboard' }}</h1>
                <p class="mt-3 text-sm leading-6 text-slate-600">
                    {{ $activeTab === 'requests' ? 'View, monitor, and manage all reservation requests submitted under your account.' : 'Stay on top of your reservation activity with a clear overview of the most important updates.' }}
                </p>
            </div>
